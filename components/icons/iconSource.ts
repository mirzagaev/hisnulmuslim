/* Vector icon set ported verbatim from app.hisnulmuslim.de/src/index.html's inline <svg><defs> sprite.
   Each entry stores the symbol's viewBox and inner markup (paths copied as-is); `class="st0"` /
   `class="heroicon-ui"` are swapped for `fill="currentColor"` so react-native-svg's SvgXml can
   resolve color via the `color` prop, same mechanism the original site's CSS used. */
...
const fillify = (markup: string) =>
  markup.replace(/class="st0"/g, 'fill="currentColor"').replace(/class="heroicon-ui"/g, 'fill="currentColor"');
...
export const ICONS: Record<string, IconDef> = {
  ...
  burgermenu: {
    viewBox: '0 0 24 24',
    stroke: true,
    inner: `<path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5"/>`,
  },
  x: {
    viewBox: '0 0 24 24',
    stroke: true,
    inner: `<path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12"/>`,
  },
  right: {
    viewBox: '0 0 24 24',
    stroke: true,
    inner: `<path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5"/>`,
  },
  search: {
    viewBox: '0 0 24 24',
    inner: fillify(`
  ...
  modeToggler: {
    viewBox: '0 0 24 24',
    stroke: true,
    inner: `<path stroke-linecap="round" stroke-linejoin="round" d="M12 3v2.25m6.364.386-1.591 1.591M21 12h-2.25m-.386 6.364-1.591-1.591M12 18.75V21m-4.773-4.227-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0Z"/>`,
  },
};
